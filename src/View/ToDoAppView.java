...
public class ToDoAppView extends JFrame {
     ...
     * @param controller ToDoAppController instance to handle task creation
     */
     ...
     * @return JPanel containing the date picker
     */
     ...
     * @return JPanel containing the input fields
     */
     ...
     * @param controller ToDoAppController instance
     * @param titleField title input field
     * @param descriptionField description input field
     * @param categoryField category dropdown
     * @param priorityBox priority dropdown
     * @param datePickerPanel date picker panel
     */
    private void handleTaskDialogSubmission(ToDoAppController controller, JTextField titleField, JTextField descriptionField, JComboBox<TaskCategory> categoryField, JComboBox<String> priorityBox, JPanel datePickerPanel) {
        ...
        try {
            controller.addTask(
                    ...
                    dueDate,
                    (TaskCategory) Objects.requireNonNull(categoryField.getSelectedItem()),
                    (String) priorityBox.getSelectedItem()
            );
        } catch (Exception e) {
            System.err.println("Failed to handle task dialog submission: " + e.getMessage());
            e.printStackTrace();
        }
    }
     ...
     * @return JComboBox containing priority options - high, medium and low
     */
     ...
     * @return JComboBox containing TaskCategory values
     */
     ...
     * @return JTable displaying tasks
     */
     ...
     * @return DefaultTableModel used by the table
     */
     ...
     * @return JButton for adding tasks
     */
     ...
     * @return JButton for marking tasks as completed
     */
     ...
     * @return JButton for deleting tasks
     */
